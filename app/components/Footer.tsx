        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link href="/" className="hover:underline">Sozan Liberal Arts</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <Link href="https://www.instagram.com/sozanla_szn/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <Link href="https://x.com/Sozan_LA" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                        ...
                        <Link href="https://github.com/sozanliberalarts" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
